...
@Test(groups = "live")
public class BaseDimensionDataCloudControllerApiLiveTest extends BaseApiLiveTest<DimensionDataCloudControlApi> {
    ...
    protected Properties setupProperties() {
        ...
        overrides.setProperty(TEMPLATE, "imageNameMatches=Ubuntu,osVersionMatches=1[456]\\.[01][04](\\.[0-9])?-LTS");
