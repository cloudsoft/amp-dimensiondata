...
import static org.jclouds.dimensiondata.cloudcontrol.utils.DimensionDataCloudControllerUtils.generatePortListName;
import static org.jclouds.dimensiondata.cloudcontrol.utils.DimensionDataCloudControllerUtils.simplifyPorts;
...
import org.jclouds.dimensiondata.cloudcontrol.compute.functions.ServerToServetWithExternalIp;
...
/**
 * defines the connection between the {@link org.jclouds.dimensiondata.cloudcontrol.DimensionDataCloudControlApi} implementation and
...
public class DimensionDataCloudControllerComputeServiceAdapter implements
    ...
    @Inject
    public DimensionDataCloudControllerComputeServiceAdapter(DimensionDataCloudControlApi api, Timeouts timeouts, CleanupServer cleanupServer) {
    ...
    public NodeAndInitialCredentials<ServerWithExternalIp> createNodeWithGroupEncodedIntoName(String group, final String name, Template template) {
        ...
        if (templateOptions.autoCreateNatRule()) {
            ...
            synchronized (mutex) {
                ...
                if (addPublicIpBlockResponse == null)
                    throw new IllegalStateException("Cannot allocate an Public IP address block");
